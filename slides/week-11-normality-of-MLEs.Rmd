...
&= \int \frac{\partial}{\partial \theta} \log(f(x|\theta)) f(x|\theta)\textrm{d}x \\
&= \int \frac{\partial}{\partial \theta} f(x|\theta) \frac{1}{f(x|\theta)} f(x|\theta)\textrm{d}x \\
&= \int \frac{\partial}{\partial \theta} f(x|\theta) \textrm{d}x \\
&= \frac{\partial}{\partial \theta} \int f(x|\theta) \textrm{d}x \\
&= \frac{\partial}{\partial \theta} \int 1 \\
&= 0
\end{align}
...
\begin{align}
\frac{\partial}{\partial \theta} 0 &= \frac{\partial}{\partial \theta} \int \frac{\partial}{\partial \theta} \log(f(x|\theta)) f(x|\theta)\textrm{d}x \\
0 &= \int \frac{\partial^2}{\partial \theta^2} \log(f(x|\theta)) f(x|\theta)\textrm{d}x + \int \frac{\partial}{\partial \theta} \log(f(x|\theta)) \frac{\partial}{\partial \theta} f(x|\theta)\textrm{d}x\\
0 &= E\left(\frac{\partial^2}{\partial \theta^2} \log(f(x|\theta))\right) + \int \frac{\partial}{\partial \theta} \log(f(x|\theta)) \frac{\frac{\partial}{\partial \theta} f(x|\theta)}{f(x|\theta)} f(x|\theta) \textrm{d}x \\
0 &= E\left(\frac{\partial^2}{\partial \theta^2} \log(f(x|\theta))\right) + \int \frac{\partial}{\partial \theta} \log(f(x|\theta)) \frac{\partial}{\partial \theta} \log(f(x|\theta)) f(x|\theta)  \textrm{d}x \\
\\
\end{align}
